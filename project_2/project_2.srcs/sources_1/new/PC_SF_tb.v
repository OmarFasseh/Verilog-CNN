...
//Change the DATA_WIDTH (EXP, MANT) depending on the test case. Please refeer to PC_SF_tb_results for more explanation.
parameter EXPONENT_WIDTH = 8;
parameter MANTISSA_WIDTH = 23;
parameter DATA_WIDTH = EXPONENT_WIDTH+MANTISSA_WIDTH+1;
parameter NUM_TEST_CASES = 2;
parameter N = 6; //Size of the image NXN
parameter image_file = "C:/Users/giga/Documents/imgs2.txt";
parameter filter_file = "C:/Users/giga/Documents/filters2.txt";

//Inputs and output registers and wires
//Inputs to PC_SF
reg clk;
reg reset;
reg [N*N*DATA_WIDTH-1:0] image; //The image used in conv unit
reg [25*DATA_WIDTH-1:0] filter; //The filter used in conv unit
