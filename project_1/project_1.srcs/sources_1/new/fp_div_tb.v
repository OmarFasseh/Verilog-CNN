...
flp_a= 32'b01000001000100000000000000000000; //9/4=2.25   


#2

flp_a= 32'b01000001010000000000000000000000; //12/4=3  

#2

flp_a =32'b00111111000000000000000000000000; //.5 /4= 0.125

#2

flp_a =32'b11000010110001100000000000000000; //-99 /4=24.75


#2

flp_a =32'b00111110010011001100110011001100; //0.2 /4 =0.05

#2

flp_a =32'b01000000001000000000000000000000; //2.5/4=0.625  

#2

flp_a =32'b01000001001000000000000000000000; //10 /4=2.5 
#2 $stop;
